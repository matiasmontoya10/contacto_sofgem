                ...
                if (validar_correo(email)) {
                    if (archivo == null) {
                        ...
                        $.ajax({
                            ...
                            type: 'post',
                            dataType: 'json',
                            data: {razon_social: razon_social, rut_empresa: rut_empresa, direccion: direccion,
                                localidad: localidad, giro: giro, email: email, representante_nombre_legal: representante_nombre_legal,
                                representante_rut_legal: representante_rut_legal, clave_firma: clave_firma
                            },
